...
import { FaChevronLeft, FaChevronRight, FaUser, FaMinus, FaPlus, FaExternalLinkAlt } from 'react-icons/fa';
        ...
        >
            ...
            <div className="max-w-[1400px] mx-auto px-6 -mt-8 relative z-20">
                <motion.div 
                    ...
                    className="bg-white p-4 shadow-xl rounded-sm border border-gray-100 flex flex-col md:flex-row gap-4 items-center"
                >
                    <div className="flex-1 w-full">
                        <select className="w-full p-3 border border-gray-300 rounded-sm focus:outline-none focus:ring-1 focus:ring-black transition">
                            <option>India</option>
                        </select>
                    </div>
                    <div className="flex-[2] w-full flex items-center border border-gray-300 rounded-sm p-3 gap-4 cursor-pointer hover:border-gray-400 transition">
                        <span className="text-sm text-gray-600">10 Sept 2026</span>
                        <FaChevronRight className="text-gray-400" />
                        <span className="text-sm text-gray-600">18 Sept 2026</span>
                    </div>
                    <div className="flex-1 w-full">
                        <input type="text" placeholder="Promo" className="w-full p-3 border border-gray-300 rounded-sm focus:outline-none focus:ring-1 focus:ring-black transition" />
                    </div>
            ...
            <div className="flex justify-center mt-12 mb-16">
                <motion.div 
                    ...
                    className="bg-gray-100 p-1 rounded-full flex border border-gray-200"
                >
                    <button className="px-8 py-2 rounded-full bg-[#2d2d2d] text-white text-sm font-bold shadow-md transition-all">
                        Room
                    </button>
                    <button className="px-8 py-2 rounded-full text-gray-600 text-sm font-bold hover:bg-gray-200 transition-all">
                        Package
                    </button>
                </motion.div>
            </div>
            ...
            <div className="max-w-[1400px] mx-auto px-6">
                ...
                <div className="mb-20">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-start">
                        <motion.div 
                            ...
                            viewport={{ once: true }}
                            className="relative aspect-[16/10] bg-gray-200 rounded-sm overflow-hidden group"
                        >
                ...
                <div className="space-y-6 mb-24">
                    {property.rooms.map((room, index) => (
                        <motion.div 
                            ...
                            className="bg-white border border-gray-200 rounded-sm p-6 shadow-sm flex flex-col xl:flex-row items-center justify-between gap-8 hover:shadow-md transition-shadow"
                        >
                            <div className="flex-1 w-full space-y-3">
                                <div className="flex items-center gap-4">
                                    <h4 className="text-xl font-bold">{room.title}</h4>
                                    <button className="text-gray-600 text-sm flex items-center gap-2 hover:underline transition">
                ...
                <div className="border-t border-gray-200 py-12 flex flex-wrap justify-center gap-x-12 gap-y-6 text-sm font-bold text-gray-800 uppercase tracking-wide">
