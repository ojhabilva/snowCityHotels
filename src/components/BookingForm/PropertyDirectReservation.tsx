    ...
    return (
        <>
            <section className="w-full bg-white text-black relative pb-10">
                ...
                {/* Select */}
                <div className="flex px-6 flex-col items-center mb-8">
                ...
                <div className="flex justify-center mt-16 px-6">
                    <Link
                        href={bookingLink}
                        className="bg-black text-white px-10 py-5 text-xl md:text-xl font-bold tracking-[0.2em] hover:bg-gray-800 transition shadow-2xl rounded-sm text-center"
                    >
                        BOOK NOW
                    </Link>
                </div>
