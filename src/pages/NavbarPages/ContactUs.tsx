...
export default function ContactUs() {
    return (
        <div className="bg-[#f2f2f2] min-h-screen font-poppins">
            {/* Hero Section */}
            <section className="relative w-full h-[50vh] md:h-[65vh] flex flex-col items-center justify-end pb-16 text-white overflow-hidden">
                <Image
                    src={Shivalaya1.src}
                ...
                <motion.h1 
                    ...
                    className="relative z-10 text-[40px] md:text-[60px] font-bold"
                >
                    Contact Us
                </motion.h1>
            </section>
