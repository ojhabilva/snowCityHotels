...
import { Shivalaya1, MontanaOffer, NatureHouse1, NatureHouse2, NatureHouse3, NatureHouse4, Property1, Property2, Property2Hover, Property3 } from "@/constent/graphic";
import FollowUsSection from "@/pages/HomePages/FollowUsSection";
import OffersBanner from "@/components/components/OffersBanner";

export default function Shivalaya() {
    const stays = [
        {
        ...
        <>
            <section className="w-full bg-white">
                ...
                <div className="max-w-6xl mx-auto text-center px-6 py-10 text-gray-700 text-sm md:text-xl leading-relaxed">
                    Welcome to Shivalaya by Snow City Stays, a carefully crafted boutique retreat designed to offer a refined and distinctive stay experience. Every space is thoughtfully curated, reflecting its own character and charm—creating an atmosphere that feels both unique and memorable.
                    At Shivalaya, we are committed to delivering warm hospitality paired with premium comforts, ensuring each guest enjoys a seamless and enriching stay. Our focus lies in attention to detail and genuine care, creating moments that stay with you long after your journey ends.
                </div>
